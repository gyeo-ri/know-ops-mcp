...
| Domain | `know_ops_mcp/know_ops/knowledge/` | `BaseKnowledge` + 서브타입 + 직렬화 |
| Infrastructure | `know_ops_mcp/know_ops/storage/` | 파일 읽기/쓰기 추상 + 백엔드 |
...
- Pydantic `BaseKnowledge` + 타입별 서브클래스 (`know_ops_mcp/know_ops/knowledge/`)
